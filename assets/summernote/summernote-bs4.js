...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    /**
     * image: [
     *   ['imageResize', ['resizeFull','resize75', 'resizeHalf', 'resizeQuarter', 'resizeNone']],
    ...
    value: function addImagePopoverButtons() {
      ...
      this.context.memo('button.resize75', function () {
        return _this3.button({
      ...
      this.context.memo('button.resize60', function () {
        return _this3.button({
          contents: '<span class="note-fontsize-10">60%</span>',
          tooltip: _this3.lang.image.resizeHalf,
          click: _this3.context.createInvokeHandler('editor.resize', '0.60')
        }).render();
      });
      ...
      this.context.memo('button.resize40', function () {
        return _this3.button({
      ...
      this.context.memo('button.resize30', function () {
        return _this3.button({
          contents: '<span class="note-fontsize-10">30%</span>',
          tooltip: _this3.lang.image.resizeHalf,
          click: _this3.context.createInvokeHandler('editor.resize', '0.30')
        }).render();
      });
      ...
      this.context.memo('button.resize15', function () {
        return _this3.button({
          contents: '<span class="note-fontsize-10">15%</span>',
          tooltip: _this3.lang.image.resizeHalf,
          click: _this3.context.createInvokeHandler('editor.resize', '0.15')
        }).render();
      });
