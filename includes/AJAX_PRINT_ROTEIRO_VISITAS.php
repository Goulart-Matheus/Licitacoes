...
foreach ($query->record as $acoes) {
    ...
    $table .= "<td valign='top'>" . $acoes['num_visita'] . "</td>";
    $table .= "<td valign='top'>" . $acoes['roteiro'] . "</td>";
    $table .= "<td valign='top'>" . $acoes['secretaria_nome'] . "</td>";
    $table .= "<td valign='top'>" . $acoes['unidade_nome'] . "</td>";  
    $table .= "<td valign='top'>" . $acoes['logradouro_nome'] . "</td>";   
    $table .= "<td valign='top'>" . $acoes['bairro_nome'] . "</td>";   
    $table .= "<td valign='top'>" . $acoes['fone'] . "</td>";   
...
$name = 'relatorio_consulta_area_fisica_unidades' . uniqid() . '.pdf';
