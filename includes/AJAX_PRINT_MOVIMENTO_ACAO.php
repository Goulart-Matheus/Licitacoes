...
foreach ($query->record as $acoes) {
    $i++;
    $dataBanco = $paging->query->record[4];
    $dataFormatada = date('d-m-Y', strtotime('data'));
    $table .= "<tr class='entered'>";
    $table .= "<td valign='top'>" . $acoes['nome_unidade'] . "</td>";
    $table .= "<td valign='top'>" . $acoes['observacao'] . "</td>";
    $table .= "<td valign='top'>" . $acoes['nome_tipo_acao'] . "</td>"; 
    $table .= "<td valign='top'>" . $acoes['nome_situacao_acao'] . "</td>";   
    $table .= "<td valign='top'>" . $dataFormatada . "</td>";
        ...
        <table>
            <tr style="background:none; border-bottom:none;">
                ...
                <td colspan="4" style="text-align:center;">
                    <h1> CADSEC - Casastros ' . $nome_relatorio . '</h1>
